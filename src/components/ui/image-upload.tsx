      ...
      <div className="space-y-2">
        {imageUrl ? (
          <div className="relative">
            <img src={imageUrl} alt="Uploaded image" className="w-full h-48 object-cover rounded-lg border" />
          ...
          >
            {uploading ? (
              <>
                ...
                <p className="mt-2 text-sm text-gray-500">Dang upload...</p>
              </>
            ) : (
              <>
                <ImageIcon className="h-8 w-8 text-gray-400" />
                <p className="mt-2 text-sm text-gray-500">{placeholder}</p>
                <p className="text-xs text-gray-400">Click de chon anh</p>
              </>
            )}
          </div>
        )}
