    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-6 md:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-6 md:space-y-8">
        <div className="text-center">
          <h2 className="mt-4 md:mt-6 text-2xl md:text-3xl font-bold text-gray-900">Đăng ký tài khoản</h2>
        ...
        <Card>
          <CardHeader className="p-4 md:p-6">
            ...
            <CardDescription className="text-xs md:text-sm">Tạo tài khoản mới để sử dụng hệ thống</CardDescription>
          </CardHeader>
          <CardContent className="p-4 md:p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 md:space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="ten" className="text-xs md:text-sm">
                  Họ và tên
                </Label>
                <Input
                  id="ten"
                ...
                />
                {errors.ten && <p className="text-xs md:text-sm text-red-500">{errors.ten.message}</p>}
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="vaiTro" className="text-xs md:text-sm">
                  Vai trò
                </Label>
                <Select onValueChange={(value) => setValue('vaiTro', value as 'chuNha' | 'nhanVien')}>
                  ...
                  <SelectContent>
                    <SelectItem value="chuNha" className="text-sm">
                      Chủ nhà
                    </SelectItem>
                    <SelectItem value="nhanVien" className="text-sm">
                      Nhân viên
                    </SelectItem>
                  </SelectContent>
                </Select>
                {errors.vaiTro && <p className="text-xs md:text-sm text-red-500">{errors.vaiTro.message}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.matKhau && <p className="text-xs md:text-sm text-red-500">{errors.matKhau.message}</p>}
              </div>

              <div className="space-y-2">
                <Label htmlFor="xacNhanMatKhau" className="text-xs md:text-sm">
                  Xác nhận mật khẩu
                </Label>
                <div className="relative">
                  <Input
